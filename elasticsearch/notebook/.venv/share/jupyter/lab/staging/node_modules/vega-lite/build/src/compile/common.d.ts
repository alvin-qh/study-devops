...
import { VgEncodeChannel, VgEncodeEntry } from '../vega.schema';
...
export declare function applyMarkConfig(e: VgEncodeEntry, model: UnitModel, propsList: (keyof MarkConfig)[]): Partial<Record<VgEncodeChannel, import("../vega.schema").VgValueRef | (import("../vega.schema").VgValueRef & {
    test?: string;
})[]>>;
