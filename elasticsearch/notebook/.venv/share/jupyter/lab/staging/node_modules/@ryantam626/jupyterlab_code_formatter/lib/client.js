...
class JupyterlabCodeFormatterClient {
    request(path, method, body, settings) {
    ...
    getAvailableFormatters() {
        return this.request('formatters', 'GET', null, services_1.ServerConnection.defaultSettings);
    }
    getVersion() {
        return this.request('version', 'GET', null, services_1.ServerConnection.defaultSettings);
    }
}
