...
class JupyterlabCodeFormatter {
    ...
    formatCode(code, formatter, options) {
        return this.client
            .request('format', 'POST', JSON.stringify({
            code,
            formatter,
            options
        }), services_1.ServerConnection.defaultSettings)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let formatterToUse of formattersToUse) {
                    ...
                    const formattedTexts = yield this.formatCode(currentTexts, formatterToUse, config[formatterToUse]);
