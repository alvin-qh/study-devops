 ...
 * <p>
 * 该类型对象通过
 * {@link alvin.study.conf.TestingConfig#testingTransactionManager(PlatformTransactionManager)
 * TestingConfig.testingTransactionManager(PlatformTransactionManager)} 方法进行装配,
 * 产生的对象交由 Bean 容器管理
 * </p>
 */
