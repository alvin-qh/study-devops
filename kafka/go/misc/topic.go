...
// 设置分区数参数项
//
// 本函数返回 CreateOption 函数, 用于改变 createOption 结构体的 NumPartition 字段值
...
// 设置分区副本数参数项
//
// 本函数返回 CreateOption 函数, 用于改变 createOption 结构体的 ReplicationFactor 字段值
...
// 创建主题
//
// 本函数用于创建指定主题, 并提供 opts 参数来设置主题的分区和副本数, 返回主题创建结果和错误对象
